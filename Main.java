class Main {
    public static void main(String[] args) {
        ...
        sim.addPolygon("root", new float[][]{{0,0.65f},{35.25f,0.65f},{35.25f,5.775f},{0,5.775f}}, new float[]{-17.675f,-12f}, new float[]{0,0}, new float[]{29,5.687f});
        sim.addPolygon("1", new float[][]{{-1,-1},{17,-1},{17,1},{-1,1}}, new float[]{-2,8}, new float[]{0,0}, new float[]{16f,0});
        sim.addPolygon("2", new float[][]{{-1,-1},{17f,-1},{17f,1},{-1,1}}, new float[]{-7,4}, new float[]{0,0}, new float[]{16,0});
        sim.addPolygon("end", new float[][]{{-8.235f, -0.814f}, {-1.501f, 0.356f}, {-0.717f, 1.248f}, {0.269f, 1.414f}, {1.385f, 0.841f}, {3.148f, 1.137f}, {3.999f, 2.483f}, {6.366f, 2.881f}, {7.906f, 1.92f}, {7.906f, -6.208f}, {5.962f, -7.499f}, {1.092f, -7.079f}, {-0.646f, -5.569f}, {-1.559f, -5.49f}, {-2.321f, -6.204f}, {-3.317f, -6.118f}, {-3.902f, -5.288f}, {-9.614f, -4.195f}, {-10.238f, -3.458f}}, new float[]{-3,-3}, new float[]{0,0}, new float[]{4.357f,-2.287f});
